...
# print('stadistica', type(stadisticas))
...
# Reverse == descending, when true sort descending
# stadisticas = {key: value for key, value in sorted(stadisticas.items(), key=lambda x:x[1][3], reverse=True)}
